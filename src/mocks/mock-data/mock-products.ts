...
export const mockProducts: ProductDoc[] = [
  {
    ...
    categories: ["židle", "dřevo", "nábytek"],
    description:
    ...
    countInStock: 10,
    availability: 10,
    createdAt: new Date("2014-04-03"),
    updatedAt: new Date("2014-04-03"),
  },
  {
    id: "2",
  ...
  },
  {
    ...
    categories: ["křeslo", "dřevo", "nábytek"],
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam at porta nibh. Cras nisi sem, consequat ut massa ac, ultricies lacinia urna. Proin augue magna, fringilla eget interdum a, eleifend at diam",
    price: 9999,
    countInStock: 3,
  ...
  },
  {
    ...
    categories: ["komoda", "dřevo", "nábytek"],
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam at porta nibh. Cras nisi sem, consequat ut massa ac, ultricies lacinia urna. Proin augue magna, fringilla eget interdum a, eleifend at diam",
    price: 15999,
    countInStock: 10,
